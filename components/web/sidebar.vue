  ...
  <div class="card border-0 rounded shadow-sm border-top-orange">
    <div class="card-body">
      ...
      <ul class="list-group">
        ...
        <nuxt-link :to="{name: 'customer-invoices'}" class="list-group-item text-decoration-none text-dark text-uppercase"><i class="fa fa-shopping-cart"></i> Orderan saya
        </nuxt-link>
        <nuxt-link :to="{name: 'customer-skins'}" class="list-group-item text-decoration-none text-dark text-uppercase"><i class="fa fa-address-card"></i> Jenis Kulit
        </nuxt-link>
